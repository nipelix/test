<template>
  <aside
    class="sb-sidebar hidden lg:block fixed top-[169px] left-0 z-10 h-[calc(100vh-169px)] w-[230px] bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 overflow-y-auto custom-scrollbar transition-transform duration-200"
